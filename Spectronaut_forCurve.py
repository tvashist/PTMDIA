...
if platform == 'Pro':
    ...
    spectronaut = pd.read_csv('20220405_152239_PTMDIAProject_Phospho_TimsTOF_Pro_Report.tsv', delimiter= '\t')


if platform == 'Exploris':
    conditions = [0.1, 0.2, 0.4, 1.0, 2.0, 4.0, 10.0]
    spectronaut = pd.read_csv('20220411_084730_PTMDIAProject_PhoshpoTestCurve_DIA_Exploris_Report.tsv', delimiter = '\t')
