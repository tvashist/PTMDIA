...
report_directory_path = "Z:/Helium_Tan/FINAL_PTMDIA/TimsTOF_Pro/DIANN/Library_3SS_Spiked/SearchOutputs/"     #Where is your DIANN output report?
...
if platform == 'TimsTOF_Pro':
    ...
    diann = pd.read_csv(report_directory_path + 'dia_nn/out/report.tsv', on_bad_lines= 'skip', delimiter= '\t',low_memory = False)
